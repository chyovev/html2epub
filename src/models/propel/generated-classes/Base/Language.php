...
abstract class Language implements ActiveRecordInterface
{
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[LanguageTableMap::COL_LOCALE] = true;
        }
    ...
    public function setLanguage($v)
    {
        ...
        if ($this->language !== $v) {
            $this->language = $v;
            $this->modifiedColumns[LanguageTableMap::COL_LANGUAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LanguageTableMap::translateFieldName('Locale', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locale = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LanguageTableMap::translateFieldName('Language', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LanguageTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'locale';
        }
        if ($this->isColumnModified(LanguageTableMap::COL_LANGUAGE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguageTableMap::COL_LOCALE)) {
            $criteria->add(LanguageTableMap::COL_LOCALE, $this->locale);
        }
        if ($this->isColumnModified(LanguageTableMap::COL_LANGUAGE)) {
            $criteria->add(LanguageTableMap::COL_LANGUAGE, $this->language);
        }
